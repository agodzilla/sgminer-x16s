...
#undef A_DARK
  ...
  { "x16s", ALGO_X16S, "", 1, 256, 256, 0, 0, 0xFF, 0xFFFFULL, 0x0000ffffUL, 32, 4 * 16 * 4194304, 0, x16s_regenhash, queue_x16s_kernel, gen_hash, append_x13_compiler_options },
